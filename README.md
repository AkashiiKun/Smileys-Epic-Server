...
- *EMI (In-game item & recipe browser)*
  ...
  - *EMI Professions*
  - *EMI++*
- FTBChunks (Allows claiming area as "yours" on a map)
...
- Waystones:
  ...
  - Waystones are not free, but cost **less** experience the further apart they are. This is to incentivize actual transportation over shorter distances (we have Create: Steam 'n' Rails for trains), while still having a convenient option for really long distances
